webpackJsonp(["profilRole.module"],{

/***/ "../../../../../src/app/admin/profilRole/profilRole.list/profilRole.list.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"chk-block\">\r\n  <div class=\"chk-block-title\">\r\n    <div class=\"row\">\r\n      <div class=\"col-lg-6\">\r\n        <div class=\"form-group\">\r\n          <button class=\"btn btn-block btn-secondary\" type=\"button\" (click)=\"cancel()\">\r\n            <i class=\"fa fa fa-arrow-left mr-2\" aria-hidden=\"true\"></i>\r\n            Annuler\r\n          </button>\r\n        </div>\r\n      </div>\r\n      <div class=\"col-lg-6\">\r\n        <div class=\"form-group\">\r\n          <button class=\"btn btn-block btn-primary\" (click)=\"saveProfilRole()\">\r\n            <i class=\"fa fa fa-save mr-2\" aria-hidden=\"true\"></i>\r\n            Enregistrer\r\n          </button>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n  <div class=\"chk-block-content\">\r\n    <div class=\"row\">\r\n      <div class=\"col-sm-12 col-md-12 col-lg-6 mb-3\">\r\n        <h2 class=\"mb-3\">Affecté</h2>\r\n        <div class=\"card\">\r\n          <div class=\"card-body bg-success\">\r\n            <div>\r\n              <div *ngFor=\"let profilRoleAffecte of profilRoleAffecteList; let profilRoleAffecteIndex = index\">\r\n                <div class=\"d-flex justify-content-between mb-3\">\r\n                  <div class=\"d-flex align-items-start flex-column\">\r\n                    <label class=\"custom-control custom-checkbox\">\r\n                      <input type=\"checkbox\" class=\"custom-control-input\" checked=\"true\" (change)=\"retirerRole(profilRoleAffecte,profilRoleAffecteIndex)\">\r\n                      <span class=\"custom-control-indicator\"></span>\r\n                      <span class=\"d-block\">{{ profilRoleAffecte.role.libelle }}</span>\r\n                    </label>\r\n                  </div>\r\n                </div>\r\n              </div>\r\n            </div>\r\n          </div>\r\n        </div>\r\n      </div>\r\n      <div class=\"col-sm-12 col-md-12 col-lg-6 mb-3\">\r\n        <h2 class=\"mb-3\">Non Affecté</h2>\r\n        <div class=\"card\">\r\n          <div class=\"card-body bg-warning\">\r\n            <div>\r\n              <div *ngFor=\"let profilRoleNonAffecte of profilRoleNonAffecteList; let profilRoleNonAffecteIndex = index\">\r\n                <div class=\"d-flex justify-content-between mb-3\">\r\n                  <div class=\"d-flex align-items-start flex-column\">\r\n                    <label class=\"custom-control custom-checkbox\">\r\n                      <input type=\"checkbox\" class=\"custom-control-input\" (change)=\"affecterRole(profilRoleNonAffecte,profilRoleNonAffecteIndex)\">\r\n                      <span class=\"custom-control-indicator\"></span>\r\n                      <span class=\"d-block\">{{ profilRoleNonAffecte.role.libelle }}</span>\r\n                    </label>\r\n                  </div>\r\n                </div>\r\n              </div>\r\n            </div>\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>"

/***/ }),

/***/ "../../../../../src/app/admin/profilRole/profilRole.list/profilRole.list.component.scss":
...
/***/ "../../../../../src/app/admin/profilRole/profilRole.list/profilRole.list.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProfilRoleListComponent; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__service_profilRole_service__ = __webpack_require__("../../../../../src/app/admin/profilRole/service/profilRole.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__profil_service_profil_service__ = __webpack_require__("../../../../../src/app/admin/profil/service/profil.service.ts");
...
var ProfilRoleListComponent = (function (_super) {
    __extends(ProfilRoleListComponent, _super);
    function ProfilRoleListComponent(profilRoleService, profilService, pageTitleService, route) {
        var _this = _super.call(this) || this;
        _this.profilRoleService = profilRoleService;
        _this.profilService = profilService;
        _this.pageTitleService = pageTitleService;
        _this.route = route;
        _this.profilRoleAffecteList = [];
        _this.profilRoleNonAffecteList = [];
        return _this;
    }
    ProfilRoleListComponent.prototype.ngOnInit = function () {
        this.pageTitleService.setTitle("AFFECTATION DES PROFILS");
        this.loadProfil();
    };
    ProfilRoleListComponent.prototype.loadProfil = function () {
        var _this = this;
        this.route.queryParams.subscribe(function (params) {
            _this.profil_id = params['profil_id'];
            _this.profilService.getProfil(_this.profil_id)
                .subscribe(function (profil) {
                _this.loadProfilRoleAffecteList(profil);
                _this.loadProfilRoleNonAffecteList(profil);
            }, function (error) {
    ...
    ProfilRoleListComponent.prototype.loadProfilRoleAffecteList = function (profil) {
        var _this = this;
        this.profilRoleService.getRoleAffecte(profil)
            .subscribe(function (profilRoleAffecteList) {
            _this.profilRoleAffecteList = profilRoleAffecteList;
        }, function (error) { return _this.showError(error.status, error.json().message); });
    };
    ProfilRoleListComponent.prototype.loadProfilRoleNonAffecteList = function (profil) {
        var _this = this;
        this.profilRoleService.getRoleNonAffecte(profil)
            .subscribe(function (profilRoleNonAffecteList) {
            _this.profilRoleNonAffecteList = profilRoleNonAffecteList;
        }, function (error) { return _this.showError(error.status, error.json().message); });
    };
    ProfilRoleListComponent.prototype.saveProfilRole = function () {
        var _this = this;
        var profilRoleList;
        //delete
        profilRoleList = [];
        for (var _i = 0, _a = this.profilRoleNonAffecteList; _i < _a.length; _i++) {
            var profilRole = _a[_i];
            if (profilRole.id != null) {
                profilRoleList.push(profilRole);
            }
        }
        if (profilRoleList.length > 0) {
            this.profilRoleService.deleteProfilRoleList(profilRoleList)
                .subscribe(function () {
        ...
        //save
        profilRoleList = [];
        for (var _b = 0, _c = this.profilRoleAffecteList; _b < _c.length; _b++) {
            var profilRole = _c[_b];
            if (profilRole.id === null) {
                profilRoleList.push(profilRole);
            }
        }
        if (profilRoleList.length > 0) {
            this.profilRoleService.saveProfilRoleList(profilRoleList)
                .subscribe(function () {
                _this.showInfo("Enregistrement effectué avec succès");
            }, function (error) { return _this.showError(error.status, error.json().message); });
        }
        this.router.navigate(["/admin/profil/list/"]);
    };
    ProfilRoleListComponent.prototype.affecterRole = function (profilRole, index) {
        this.profilRoleAffecteList.push(profilRole);
        this.profilRoleNonAffecteList.splice(index, 1);
    };
    ProfilRoleListComponent.prototype.retirerRole = function (profilRole, index) {
        this.profilRoleNonAffecteList.push(profilRole);
        this.profilRoleAffecteList.splice(index, 1);
    };
    ProfilRoleListComponent.prototype.cancel = function () {
        this.router.navigate(["/admin/profil/edit/" + this.profil_id]);
    };
    return ProfilRoleListComponent;
}(__WEBPACK_IMPORTED_MODULE_2__core_component_base_component__["a" /* BaseComponent */]));
ProfilRoleListComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'ms-profilRole-list',
        template: __webpack_require__("../../../../../src/app/admin/profilRole/profilRole.list/profilRole.list.component.html"),
        styles: [__webpack_require__("../../../../../src/app/admin/profilRole/profilRole.list/profilRole.list.component.scss")],
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_3__service_profilRole_service__["a" /* ProfilRoleService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__service_profilRole_service__["a" /* ProfilRoleService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_5__profil_service_profil_service__["a" /* ProfilService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__profil_service_profil_service__["a" /* ProfilService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_4__core_page_title_page_title_service__["a" /* PageTitleService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__core_page_title_page_title_service__["a" /* PageTitleService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_6__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__angular_router__["a" /* ActivatedRoute */]) === "function" && _d || Object])
], ProfilRoleListComponent);

var _a, _b, _c, _d;
//# sourceMappingURL=profilRole.list.component.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProfilRoleModule", function() { return ProfilRoleModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__profilRole_routing__ = __webpack_require__("../../../../../src/app/admin/profilRole/profilRole.routing.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__service_profilRole_service__ = __webpack_require__("../../../../../src/app/admin/profilRole/service/profilRole.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__profilRole_list_profilRole_list_component__ = __webpack_require__("../../../../../src/app/admin/profilRole/profilRole.list/profilRole.list.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__role_service_role_service__ = __webpack_require__("../../../../../src/app/admin/role/service/role.service.ts");
...
var ProfilRoleModule = (function () {
    function ProfilRoleModule() {
    }
    return ProfilRoleModule;
}());
ProfilRoleModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_1__angular_router__["e" /* RouterModule */].forChild(__WEBPACK_IMPORTED_MODULE_6__profilRole_routing__["a" /* ProfilRoleRoutes */])
        ],
        declarations: [
            __WEBPACK_IMPORTED_MODULE_8__profilRole_list_profilRole_list_component__["a" /* ProfilRoleListComponent */],
        ],
        providers: [
            __WEBPACK_IMPORTED_MODULE_7__service_profilRole_service__["a" /* ProfilRoleService */],
            __WEBPACK_IMPORTED_MODULE_11__role_service_role_service__["a" /* RoleService */],
            __WEBPACK_IMPORTED_MODULE_12__profil_service_profil_service__["a" /* ProfilService */]
        ],
    })
], ProfilRoleModule);

//# sourceMappingURL=profilRole.module.js.map

/***/ }),

/***/ "../../../../../src/app/admin/profilRole/profilRole.routing.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProfilRoleRoutes; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__profilRole_list_profilRole_list_component__ = __webpack_require__("../../../../../src/app/admin/profilRole/profilRole.list/profilRole.list.component.ts");

var ProfilRoleRoutes = [{
        path: '',
        redirectTo: 'list',
        pathMatch: 'full',
    }, {
        path: '',
        children: [{ path: 'list', component: __WEBPACK_IMPORTED_MODULE_0__profilRole_list_profilRole_list_component__["a" /* ProfilRoleListComponent */] }]
    }];
//# sourceMappingURL=profilRole.routing.js.map

/***/ }),

/***/ "../../../../../src/app/admin/profilRole/service/profilRole.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProfilRoleService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
...
var ProfilRoleService = (function () {
    function ProfilRoleService(settings, authHttp) {
        this.settings = settings;
        this.authHttp = authHttp;
    }
    ProfilRoleService.prototype.saveProfilRoleList = function (profilRoleList) {
        return this.authHttp.post(this.settings.baseUrl + "/profilRole/saveList", JSON.stringify(profilRoleList));
    };
    ProfilRoleService.prototype.deleteProfilRoleList = function (profilRoleList) {
        return this.authHttp.post(this.settings.baseUrl + "/profilRole/deleteList", JSON.stringify(profilRoleList));
    };
    ProfilRoleService.prototype.getRoleAffecte = function (profil) {
        return this.authHttp.post(this.settings.baseUrl + "/profilRole/getProfilRoleAffecte", JSON.stringify(profil))
            .map(function (res) { return res.json(); });
    };
    ProfilRoleService.prototype.getRoleNonAffecte = function (profil) {
        return this.authHttp.post(this.settings.baseUrl + "/profilRole/getProfilRoleNonAffecte", JSON.stringify(profil))
            .map(function (res) { return res.json(); });
    };
    return ProfilRoleService;
}());
ProfilRoleService = __decorate([
...
var _a, _b;
//# sourceMappingURL=profilRole.service.js.map

/***/ }),

/***/ "../../../../../src/app/admin/role/service/role.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var RoleService = (function () {
    function RoleService(settings, authHttp) {
        this.settings = settings;
        this.authHttp = authHttp;
    }
    RoleService.prototype.getRoleList = function () {
        return this.authHttp.get(this.settings.baseUrl + '/role/list')
            .map(function (res) { return res.json(); });
    };
    return RoleService;
}());
...
//# sourceMappingURL=profilRole.module.chunk.js.map